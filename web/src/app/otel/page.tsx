...
export default function OtelPage() {
  return (
    <main className="bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 py-12">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
          <div className="rounded-3xl border border-orange-200 bg-white/80 p-8 shadow-xl shadow-orange-200/70 backdrop-blur">
          ...
          <div className="rounded-3xl border border-orange-200 bg-white/80 p-6 shadow-lg shadow-orange-200/50 backdrop-blur">
